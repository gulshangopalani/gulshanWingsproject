          ...
          <table class="table table-striped table-bordered my-market">
            ...
            <tbody>
              <tr ng-repeat="mtchRs in matchResult">
                <td data-label="Match Name"><a href="" ui-sref="masterDashboard.Matchodds({MatchId: mtchRs.matchId,MarketId:mtchRs.marketId,matchName:mtchRs.matchName,date:mtchRs.date})">{{mtchRs.matchName}}</a></td>
